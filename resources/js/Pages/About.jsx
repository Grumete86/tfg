        ...
        <>
            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                ...
                <div className="relative min-h-screen flex flex-col items-center justify-center selection:bg-indigo-500 selection:text-white">
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl flex-1 flex flex-col justify-between">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            <a href={route('welcome')} className="flex lg:justify-center lg:col-start-2">
                                <svg
                        ...
                        <main className="flex flex-col mt-6 items-center w-full">
                            <div className="grid gap-6 lg:grid-cols-1 lg:gap-8 w-full sm:w-4/5 md:w-3/4 lg:w-3/5 xl:w-2/4">
                                <div
                                ...
                                >
                                    <h2 className="text-4xl font-semibold text-indigo-800 dark:text-white text-center" style={{ textWrap: 'balance' }}>
                                        Bruno Prádanos Herce
                                    </h2>
                                    <p className="text-sm/relaxed text-center" style={{ textWrap: 'balance' }}>
                                        Estudiante de Diseño de Aplicaciones web en
                                    </p>
                                    <div>
                                        <img src="https://fpdrioja.es/wp-content/uploads/2021/02/FPD_header.png" alt="" />
                                    </div>
